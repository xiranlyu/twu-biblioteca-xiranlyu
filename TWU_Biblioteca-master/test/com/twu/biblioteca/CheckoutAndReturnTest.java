...
public class CheckoutAndReturnTest {
    ...
    public void checkoutABook() {
        ...
        newCustomer.getConsole().checkoutBooks("9780134177304", "admin");
    ...
    public void returnABook() {
        BibliotecaApp newCustomer = new BibliotecaApp();
        newCustomer.getConsole().checkoutBooks("9780132345286", "admin");
        newCustomer.getConsole().returnBooks("9780132345286");
